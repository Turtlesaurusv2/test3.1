...
product.pd_id,COUNT(product.pd_c) as pdc, product.company_id,sum(product.quantity) as quantity,inv_sub.inv_id,product.pd_c,sum(rfs2.inventory.sell) as sell,sum(rfs2.inventory.buy) as buy,
...
WHERE product.company_id = $company_id AND inv_sub.inv_id = $inv_id
